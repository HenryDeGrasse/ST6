...
export default defineConfig({
  ...
  projects: [
    {
      name: 'chromium',
      testMatch: /(golden-path|ic-lifecycle-browser|manager-dashboard-browser|ai-features-browser|ai-workflow-browser|full-ai-lifecycle-browser|manager-phase5-browser|capacity-digest-browser|checkin-carryforward-browser|error-handling-browser|accessibility-e2e|my-insights|my-insights-browser|backlog-browser|team-management-browser|admin-dashboard-browser|persona-switching|executive-dashboard|urgency-indicators-browser|ui-foundations-browser)\.spec\.ts$/,
