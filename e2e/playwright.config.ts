...
export default defineConfig({
  ...
  projects: [
    {
      name: 'chromium',
      testMatch: /(golden-path|ic-lifecycle-browser|manager-dashboard-browser|ai-features-browser|error-handling-browser|accessibility-e2e|my-insights|my-insights-browser|persona-switching|executive-dashboard)\.spec\.ts$/,
