...
describe("TeamDashboardFiltersPanel", () => {
  it("renders the outcome ID filter", () => {
    render(<TeamDashboardFiltersPanel filters={{}} onFiltersChange={vi.fn()} />);
  ...
  it("applies a valid outcome ID filter", async () => {
    ...
    render(<TeamDashboardFiltersPanel filters={{}} onFiltersChange={onFiltersChange} />);

    await userEvent.type(screen.getByTestId("filter-outcome-id"), "123e4567-e89b-12d3-a456-426614174000");
